...
document.addEventListener('DOMContentLoaded', function() {
    ...
    forms.forEach(function(form) {
        ...
        inputs.forEach(function(input) {
            input.addEventListener('focus', function() {
                ...
                if (viewport) {
                    viewport.setAttribute('content', 'width=device-width, initial-scale=1.0, user-scalable=0, minimal-ui, maximum-scale=1.0');
                }
            });
    ...
    const mobileSearchToggle = document.querySelector('.d-inline-flex.d-md-none .pc-head-link');
